...
function seqRandNumber3(min: number, max: number, len: number) {
...
const myRandArray2 = seqRandNumber3(1, 30, 10); //l'ultima cifra è la length dell'array, passata come parametro
